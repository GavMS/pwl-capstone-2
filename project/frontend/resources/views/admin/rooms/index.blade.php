...
.search-wrap input {
    ...
    outline: none; width: 280px; background: #fff;
...
.room-name-bold { font-size: .875rem; font-weight: 600; color: #344767; }
.cell-text { font-size: .875rem; color: #7b809a; }
.asset-count {
    display: inline-flex; align-items: center; justify-content: center;
    min-width: 1.75rem; height: 1.5rem; padding: 0 .5rem;
    border-radius: .35rem; font-size: .75rem; font-weight: 600;
    background: #eff6ff; color: #1d4ed8; border: 1px solid #bfdbfe;
}
.asset-count-zero { background: #f8fafc; color: #94a3b8; border-color: #e2e8f0; }
...
<div style="display:flex; align-items:flex-start; justify-content:space-between; flex-wrap:wrap; gap:.75rem; margin-bottom:1.25rem;">
    <div>
        <h4 style="font-size:1.25rem; font-weight:700; color:#344767; margin:0 0 .25rem;">Manajemen Ruangan</h4>
        <p style="font-size:.875rem; color:#7b809a; margin:0;">Daftar laboratorium dan ruang penyimpanan di fakultas</p>
    </div>
                ...
                <tr class="room-row">
                    ...
                    <td>
                        <div class="action-group">
                            <a href="{{ route('admin.rooms.edit', $r['id']) }}" class="btn-icon btn-icon-edit" title="Edit">
...
function filterTable() {
    ...
    document.getElementById('roomCount').textContent = `${visible} ruangan`;
}
