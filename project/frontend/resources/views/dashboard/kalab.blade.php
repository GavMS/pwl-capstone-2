...
.section-card-header { display: flex; align-items: center; justify-content: space-between; padding: 1.125rem 1.5rem; border-bottom: 1px solid #f0f2f5; }
...
<div style="margin-bottom:1.5rem;">
    ...
    <p class="greeting-sub">Ringkasan pengadaan barang laboratorium hari ini</p>
</div>

<div class="flex flex-wrap -mx-3 mb-0">
    <div class="w-full max-w-full px-3 mb-4 sm:w-1/3 xl:w-1/3 xl:mb-0">
        <div class="stat-card">
    ...
    <div class="w-full max-w-full px-3 mb-4 sm:w-1/3 xl:w-1/3 xl:mb-0">
        <div class="stat-card">
            ...
            <div>
                <p class="stat-label">Disetujui Kaprodi</p>
                <h3 class="stat-number">{{ $p['approved'] ?? 0 }}</h3>
                <p class="stat-sub">{{ $p['rejected'] ?? 0 }} ditolak</p>
            </div>
        </div>
    </div>
</div>
...
<div class="section-card">
    ...
    <div class="quicklinks">
        ...
        <a href="{{ route('kalab.procurement.index') }}" class="quicklink-btn">
            ...
            <div>
                <div style="font-size:.875rem;font-weight:600;color:#344767;">Draf Pengadaan</div>
                <div style="font-size:.75rem;color:#adb5bd;">Kelola semua usulan</div>
            </div>
        </a>
        <a href="{{ route('kalab.inventaris.index') }}" class="quicklink-btn">
            <div class="qi" style="background:linear-gradient(310deg,#17ad37,#98ec2c);"><i class="fas fa-box-open"></i></div>
            <div>
                <div style="font-size:.875rem;font-weight:600;color:#344767;">Inventaris Aset</div>
                <div style="font-size:.75rem;color:#adb5bd;">Lihat daftar aset lab</div>
            </div>
        </a>
        <a href="{{ route('kalab.bhp.index') }}" class="quicklink-btn">
            <div class="qi" style="background:linear-gradient(310deg,#f5365c,#f56036);"><i class="fas fa-flask"></i></div>
            <div>
                <div style="font-size:.875rem;font-weight:600;color:#344767;">BHP</div>
                <div style="font-size:.75rem;color:#adb5bd;">Bahan habis pakai lab</div>
            </div>
        </a>
    </div>
</div>
